...
export default function UserDetailPage() {
    const params = useParams() as { userId: string; encryptedPortalId: string; role: string; encryptedUserId: string };
    ...
    const backUrl = `/u/crm/${params.encryptedPortalId}/${params.role}/${params.encryptedUserId}/user-management`;
