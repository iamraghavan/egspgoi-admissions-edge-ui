...
export default function CampaignDetailPage() {
    const params = useParams() as { campaignId: string, encryptedPortalId: string, role: string, encryptedUserId: string };
    ...
    const backUrl = `/u/crm/${params.encryptedPortalId}/${params.role}/${params.encryptedUserId}/campaigns`;
